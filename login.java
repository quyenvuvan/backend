...
public class login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("center hodpital");
        ...
        jLabel5.setIcon(new javax.swing.ImageIcon("C:\\Users\\admin\\Downloads\\pixilart-drawing.png")); // NOI18N
        ...
        getContentPane().add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(256, 0, -1, -1));
    ...
    private void jButton1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MouseClicked
        String query="SELECT * FROM DOCTOR WHERE name='"+username.getText()+"' and password='"+password.getText()+"';";
        try{
                Con = DriverManager.getConnection("jdbc:sqlserver://localhost:1433;"
                        + "databaseName=quyenvu;encrypt=true;trustServerCertificate=true","sa","12345678");
